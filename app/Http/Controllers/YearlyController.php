...
class YearlyController extends Controller
{
    ...
    */
    public function yearlyResult() {
        ...
        return view('yearly',compact('user','product_bases','asps','yearly_chart','yearly_cvs','yearly_clicks','yearly_imps','yearly_approvals','yearly_cvrs','yearly_ctrs','yearly_cvs_asp','yearly_clicks_asp','yearly_imps_asp','yearly_ctrs_asp','yearly_cvrs_asp'));
    }
    ...
    */
	public function yearlyResultSearch(SearchYearlyRequest $request) {
        ...
        return view('yearly',compact('user','asps','product_bases','yearly_cvs','yearly_clicks','yearly_imps','yearly_approvals','yearly_cvrs','yearly_ctrs','yearly_cvs_asp','yearly_clicks_asp','yearly_imps_asp','yearly_ctrs_asp','yearly_cvrs_asp','yearly_chart'));
