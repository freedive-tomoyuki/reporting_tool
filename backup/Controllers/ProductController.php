...
class ProductController extends Controller
{
    ...
    public function list() {
        ...
        return view('product_list',compact('products','products_bases','user'));
    }
    ...
    public function detail($id) {
        ...
        return view('product_detail',compact('asps','user'));
    }
    ...
    public function add() {
        ...
        return view('product_new',compact('product_bases','asps','user'));
    }
    ...
    public function add_product_base() {
        ...
        $user = Auth::user();
        return view('product_base_new',compact('user'));
    }
    //各親案件の追加実装
    ...
    public function edit($id=null,Request $request) {
        ...
        return view('product_edit',compact('product_bases','asps','products','user'));
    }
    //各案件の編集実装
