...
*/
    ...
    public function a8_($product_base_id){//OK
   ...
   public function accesstrade_($product_base_id){//OK
   ...
   public function valuecommerce_($product_base_id){
   ...
   public function afb_($product_base_id){//OK
    ...
    public function rentracks_($product_base_id){//OK
...
*/
    ...
    public function run(Request $request){
          ...
          foreach ($asp_array as $name){
            ...
            echo $functionName = str_replace(' ', '' ,mb_strtolower($name["name"]));
            echo $className = __NAMESPACE__ . '\\' . 'Asp\Daily'. '\\'.str_replace(' ', '' ,$name["name"]).'Controller';
            $run = new $className();
