...
class Create201912MonthlysitesTable extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     */
    public function up(){
        Schema::create('201912_monthlysites', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('201912_monthlysites');
    }
}
