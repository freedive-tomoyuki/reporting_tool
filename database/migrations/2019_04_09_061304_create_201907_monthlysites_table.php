...
class Create201907MonthlysitesTable extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     */
    public function up(){
        Schema::create('201907_monthlysites', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('201907_monthlysites');
    }
}
