...
class Create201910MonthlysitesTable extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     */
    public function up(){
        Schema::create('201910_monthlysites', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('201910_monthlysites');
    }
}
