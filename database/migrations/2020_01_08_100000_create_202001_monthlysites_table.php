...
class Create202001MonthlysitesTable extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     */
    public function up(){
        Schema::create('202001_monthlysites', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('202001_monthlysites');
    }
}
