...
class Create202002MonthlysitesTable extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     */
    public function up(){
        Schema::create('202002_monthlysites', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('202002_monthlysites');
    }
}
