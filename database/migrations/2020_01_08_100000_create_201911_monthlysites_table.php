...
class Create201911MonthlysitesTable extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     */
    public function up(){
        Schema::create('201911_monthlysites', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('201911_monthlysites');
    }
}
