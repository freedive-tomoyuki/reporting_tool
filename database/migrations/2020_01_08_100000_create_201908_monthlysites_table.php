...
class Create201908MonthlysitesTable extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     */
    public function up(){
        Schema::create('201908_monthlysites', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('201908_monthlysites');
    }
}
