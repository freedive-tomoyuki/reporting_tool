...
class Create201909MonthlysitesTable extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     */
    public function up(){
        Schema::create('201909_monthlysites', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('201909_monthlysites');
    }
}
