...
class Create201906MonthlysitesTable extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     */
    public function up(){
        Schema::create('201906_monthlysites', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('201906_monthlysites');
    }
}
