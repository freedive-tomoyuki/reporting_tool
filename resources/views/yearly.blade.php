...
@section('content')
      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default ">
          ...
          <div class="panel-body">
            <div class="col-md-6">
              <form role="form" action="{{ url('yearly_result')}}" method="post" class="form-horizontal">
                @csrf
    ...
    && isset($yearly_cvs)
    && isset($yearly_cvrs)
    && isset($yearly_imps_asp)
    && isset($yearly_clicks_asp)
    && isset($yearly_ctrs_asp)
    && isset($yearly_cvs_asp)
    && isset($yearly_cvrs_asp))
<!--グラフ-->
    <div class="row">
      <div class="col-lg-12">
          <div class="panel panel-default">
